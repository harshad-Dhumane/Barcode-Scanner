...
public class Scanning_Activity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        btnAction = findViewById(R.id.idBtnGetStarted);
        btnAction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Scanning_Activity.this,MainActivity2.class);
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(Scanning_Activity.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        ActivityCompat.requestPermissions(Scanning_Activity.this, new
